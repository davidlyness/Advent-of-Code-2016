...
def find_first_crossover(instructions):
    """
    Calculates the first position visited twice.
    :param instructions: direction and movement instructions
    :return: the number of blocks between the current position and starting position
    """
...
print(find_first_crossover(data))
