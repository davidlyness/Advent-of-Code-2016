...
#  There are only ~40k candidates to check, so brute force instead of calculating individual reverse operations.
for candidate in ["".join(c) for c in itertools.permutations("abcdefgh")]:
